        ...
        <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {BAIRROS.map((b) => (
            <a
              key={b}
              href="#hero-estimator"
              className="flex items-center gap-2 rounded-xl bg-white px-4 py-3.5 text-sm font-medium text-gray-700 ring-1 ring-gray-100 transition hover:text-primary hover:ring-primary"
            >
